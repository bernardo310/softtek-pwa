...
class ProductList extends Component {
    ...
    handleScroll = (e) => {
        const bottom = this.myRef.scrollHeight - this.myRef.scrollTop === this.myRef.clientHeight;
        console.log(bottom);
        if (bottom) { alert("bottom of element") }
      }
        ...
        return(
            <>
                {[...this.props.products].map(([key, value]) => (
                    <div id={key} className='mb-5' onScroll={this.handleScroll} ref={this.myRef} >
